(function ( $ ) {
    ...
    function renderDateRange(parameter){
        ...
        return '<div id="daterange" style="float: left; margin: 0px 0;" class="selectbox active">'  +
            '<input type="text" data-time-picker="true" value="'+value+'" name="'+dateRangeName+'" style="width: 200px;" placeholder="start date - end date" 	class="form-control text-input-js">' + '<p style="color:grey; font-size:11px;padding:0px 0px 0px 5px;"> Ex: 04/06/2017 - 04/06/2018 [mm/dd/yyyy]</p>' +
            '</div>';
    }
